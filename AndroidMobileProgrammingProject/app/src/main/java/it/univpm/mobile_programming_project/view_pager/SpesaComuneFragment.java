...
public class SpesaComuneFragment extends Fragment {
    ...
    public static SpesaComuneFragment newInstance(String param1, String param2) {
        SpesaComuneFragment fragment = new SpesaComuneFragment();
