 ...
 * Use the {@link CreaFragment#newInstance} factory method to
...
public class CreaFragment extends Fragment {
    ...
    public static CreaFragment newInstance(String param1, String param2) {
        CreaFragment fragment = new CreaFragment();
