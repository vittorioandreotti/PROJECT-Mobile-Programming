...
public class BolletteSpeseAdapter extends InterfaceSpeseAdapter {

    public BolletteSpeseAdapter(List<Spesa> listaSpese, RecyclerViewClickListener listener, int tipoUtenteAutenticato) {
    ...
    public SpesaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_spesa_bollette, parent, false);
